			...
			<Stack>
				<StackItem width="50%" lg-width="100%">
					...
					<Text as="h2" margin="12px 0" font="--headline2" md-font="--headline3">
						Пляж «Якоби» — одна из самых популярных рекреационных зон отдыха в городе Иркутске. Его местоположение знает практически каждый местный житель. Ещё бы, ведь согласно статистике, побережье вдоль одноимённого залива ежедневно посещает больше 1 500 человек{"\n\n"}
					</Text>
				</StackItem>
				<StackItem width="50%" lg-width="100%">
